	...
	*/
	...
	var controls = {
	  ...
	  createIcon: function createIcon(type, attributes) {
	    ...
	    var iconPath = "#".concat(this.config.iconPrefix); // Create <svg>
	...
	function () {
	  ...
	  _createClass(PreviewThumbnails, [{
	    ...
	    value: function setThumbContainerPos() {
	      ...
	      var previewPos = (this.mousePosX - seekbarRect.left - container.clientWidth / 2);// || this.event.touch.X - seekbarRect.left - container.clientWidth / 2();
	...
	(function () {
	  ...
	  document.addEventListener('DOMContentLoaded', function () {
	    singleton.context(function () {
	      ...
	      var preview_vtt = document.getElementById("player_js_thumb").getAttribute("preview_thumb");
